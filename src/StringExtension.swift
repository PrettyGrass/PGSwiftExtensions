...
extension String {
    /// Des: Init string with a base64 encoded string
    init ? (base64: String) {
    ...
    /// Des: Cut string from integerIndex to the end
    public subscript(integerIndex: Int) -> Character {
        let index = self.index(startIndex, offsetBy: integerIndex)
        return self[index]
    }
    
    /// Des: Cut string from range
    ...
    /// Des: Cut string from closedrange
    ...
    /// Des: Counts number of instances of the input inside String
    public func count(_ substring: String) -> Int {
        return components(separatedBy: substring).count - 1
    }
    
    /// Des: Capitalizes first character of String
    public mutating func capitalizeFirst() {
        guard self.count > 0 else { return }
        self.replaceSubrange(startIndex...startIndex, with: String(self[startIndex]).capitalized)
    }
    
    /// Des: Capitalizes first character of String, returns a new string
    ...
    /// Des: Uppercases first 'count' characters of String
    ...
    /// Des: Uppercases first 'count' characters of String, returns a new string
    ...
    /// Des: Uppercases last 'count' characters of String
    ...
    /// Des: Uppercases last 'count' characters of String, returns a new string
    ...
    /// Des: Uppercases string in range 'range' (from range.startIndex to range.endIndex)
    ...
    /// Des: Uppercases string in range 'range' (from range.startIndex to range.endIndex), returns new string
    ...
    /// Des: Lowercases first 'count' characters of String
    ...
    /// Des: Lowercases first 'count' characters of String, returns a new string
    ...
    /// Des: Lowercases last 'count' characters of String
    ...
    /// Des: Lowercases last 'count' characters of String, returns a new string
    ...
    /// Des: Lowercases string in range 'range' (from range.startIndex to range.endIndex)
    ...
    /// Des: Lowercases string in range 'range' (from range.startIndex to range.endIndex), returns new string
    ...
    /// Des: Counts whitespace & new lines
    ...
    /// Des: Checks if string is empty or consists only of whitespace and newline characters
    public var isBlank: Bool {
        let trimmed = trimmingCharacters(in: .whitespacesAndNewlines)
        return trimmed.isEmpty
    }
    
    /// Des: Trims white space and new line characters
    public mutating func trim() {
        self = self.trimmed()
    }
    
    /// Des: Trims white space and new line characters, returns a new string
    public func trimmed() -> String {
        return self.trimmingCharacters(in: .whitespacesAndNewlines)
    }
    
    /// Des: Position of begining character of substing
    ...
    /// Des: split string using a spearator string, returns an array of string
    ...
    /// Des: split string with delimiters, returns an array of string
    ...
    /// Des : Returns count of words in string
    ...
    /// Des : Returns count of paragraphs in string
    ...
    /// Des: Find matches of regular expression in string
    ...
    /// Des: Checks if String contains Email
    ...
    /// Des: Returns if String is a number
    public func isNumber() -> Bool {
        return NumberFormatter().number(from: self) != nil ? true : false
    }
    
    /// Des: Extracts URLS from String
    ...
    ///Des: Returns the first index of the occurency of the character in String
    ...
    /// Des: Converts String to NSString
    public var toNSString: NSString { return self as NSString }
    
    #if os(iOS)
    
    ///Des: Returns bold NSAttributedString
    ...
    ///Des: Returns underlined NSAttributedString
    ...
    ///Des: Returns italic NSAttributedString
    ...
    ///Des: Returns hight of rendered string
    ...
    ///Des: Returns NSAttributedString
    ...
    /// Des: Checks if String contains Emoji
    ...
    // Des: URL encode a string (percent encoding special chars)
    public func urlEncoded() -> String {
        return self.addingPercentEncoding(withAllowedCharacters: .urlHostAllowed)!
    }
    
    // Des: URL encode a string (percent encoding special chars) mutating version
    mutating func urlEncode() {
        self = urlEncoded()
    }
    
    // Des: Removes percent encoding from string
    public func urlDecoded() -> String {
        return removingPercentEncoding ?? self
    }
    
    // Des : Mutating versin of urlDecoded
...
/// Des: Pattern matching of strings via defined functions
public func ~=<T> (pattern: ((T) -> Bool), value: T) -> Bool {
    return pattern(value)
}

/// Des: Can be used in switch-case
