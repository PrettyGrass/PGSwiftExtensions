...
extension UITextField {
    ...
    public func setPlaceHolder(text: String, textColor: UIColor, font: UIFont) {
        let placeholserAttributes = [NSAttributedString.Key.foregroundColor : textColor ,NSAttributedString.Key.font : font]
        self.attributedPlaceholder = NSAttributedString(string: text,attributes: placeholserAttributes)
    }
}
